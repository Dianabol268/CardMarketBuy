...
public class TestMain {
        ...
        * @param accessSecret
        */
       public TestMain(String appToken, String appSecret, String accessToken, String accessSecret) {
       ...
       public static void main(String[] args) {
           ...
           String mkmAppToken = "VcCigHQVEOqiftlI" ;
           String mkmAppSecret = "QIOg2b0GWvLX1LRV2NlygFKwyzn8Brp1" ;
           String mkmAccessToken = "um6OGMVy0po7ZINCa8cSEHHCo0yjhVFJ" ;
           String mkmAccessTokenSecret = "G9IUsEXVUZshO8hqqdIJfocZ0dGd3bLp" ;


           TestMain app = new TestMain(mkmAppToken, mkmAppSecret, mkmAccessToken, mkmAccessTokenSecret);

//           if (app.request("https://www.mkmapi.eu/ws/v1.1/account")) {
//               System.out.println(app.responseContent());
//           }

           // test with active console debug
           app.setDebug(true);
//           if (app.request("https://www.mkmapi.eu/ws/v1.1/products/island/1/1/false")) {
//               // .. process(app.responseContent());
//           }

           if (app.request("https://www.mkmapi.eu/ws/v1.1/products/serra_angel/1/1/false")) {//  game  lenguaje isexact
               // .. process(app.responseContent());
           }
//           if (app.request("https://www.mkmapi.eu/ws/v1.1/products/goblin_ch/1/1/false")) {
//               // .. process(app.responseContent());
//           }
